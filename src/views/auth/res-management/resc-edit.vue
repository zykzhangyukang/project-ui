...
<script>
    ...
    export default {
        ...
        methods:{
            handleCancel(){
                this.resEditModal.visible = false;
                this.form = {};
            },
            handleOk(){
                this.loading = true;
                this.$sendAjax.doPost(API.userRescUpdate,this.form,{emulateJSON: true}).then(()=>{
                    this.form = {};
            ...
            select(resId){
                this.loading = true;
                const params = {rescId: resId};
                this.$sendAjax.doGet(API.userRescSelect,{params}).then((data)=>{
        ...
        created() {
            this.select(this.resEditModal.rescId);
        }
    }
</script>
